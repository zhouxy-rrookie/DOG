...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOE, ACC_INT_Pin|GYRO_INT_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : POWER_OUT2_Pin POWER_OUT1_Pin POWER_OUT5V_Pin ACC_CS_Pin
                           GYRO_CS_Pin */
  GPIO_InitStruct.Pin = POWER_OUT2_Pin|POWER_OUT1_Pin|POWER_OUT5V_Pin|ACC_CS_Pin
                          |GYRO_CS_Pin;
